...
def parse_args():
    ...
    parser.add_argument('--hid_dim', type=int, default=1200, help='the dimensionality of hidden layer')
    parser.add_argument('--data_dir', type=str, default='/data/ZSL/datasets/CUB', help='the train directory')
    parser.add_argument('--lamb', type=float, default=2, help='the balance parameter')
    parser.add_argument('--alpha', type=float, default=0.5, help='the balance parameter')
    ...
    parser.add_argument('--T', type=int, default=6, help='the temperature')
